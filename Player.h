...
enum ePlayerFields2 {
    ...
    PlayerField_CharacterSlot                   = 0x750, // this will be the head
	PlayerField_BagStart						= 0x7E8, // 4 bag GUIDs will be listed starting here
	PlayerField_BackPackStart					= 0x810, // all items go through 0x5D8, these are the GUIDs of items in the backpack
	PlayerField_BankStart						= 0x888, // these items are in the bank (NOT in bags)
	PlayerField_BankBags						= 0x968, // these are the GUIDs of the BAGS in your bank
	PlayerField_Keys							= 0xA00, // player keys
