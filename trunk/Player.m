...
- (NSArray*)itemGUIDsOfBags{
	...
	for ( i = 0; i < numberOfBags; i++ ){
		if([_memory loadDataForObject: self atAddress: ([self playerFieldsAddress] + PLAYER_FIELD_INV_SLOT_HEAD + sizeof(GUID)*i) Buffer: (Byte *)&value BufLength: sizeof(value)]) {
